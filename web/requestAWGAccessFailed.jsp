...
<html>
    ...
    <body>
        <div style="text-align: center"><%@include file="/includes/banner.jsp" %><b>Sign Up:</b>
            <h3>Account Creation Failed. (Try another User Name)</h3>
        </div>
        <form action="addUser" method="post">
            <table cellspacing="8" border="0">
                ...
                <tr>
                    <td align="right"></td>
                    <td><input type="hidden" name="cardVerifed" value="n"></td>
                </tr>
                <tr>
                    <td align="right"></td>
