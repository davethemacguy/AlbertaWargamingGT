                ...
                <tr valign="top">
                    <td>
                        ...
                        <div id="instafeedStyling">
                            ...
                            <div style="height: 420px; float: left; overflow-y: scroll;" id="instafeed"></div>
                        </div>
                    </td>
                    <td>
                        <div style="width: 530px; text-align:center; height: 100% auto; text-align:justify;">
                            <br>
                            <center><div class="fb-like-box" data-href="https://www.facebook.com/AlbertaGrandTournamentCircuit"  data-width="530" data-height="750" data-show-faces="false" data-header="false" data-stream="true" data-show-border="false"></div></center>
                            <!--Facebook script-->
                            <script>(function(d, s, id) {
                            var js, fjs = d.getElementsByTagName(s)[0];
                            if (d.getElementById(id)) return;
